...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        if UserDefaults.standard.bool(forKey: "getStartedBtnPressed") {
            ...
            if let instantiateVC = storyBoard.instantiateViewController(withIdentifier: "WelcomeView") as? UINavigationController {
                window?.rootViewController = instantiateVC
            }
        }else{
            let storyBoard = UIStoryboard(name: "Onboarding", bundle: nil)
            if let instantiateVC = storyBoard.instantiateViewController(withIdentifier:"WalkthroughViewController") as? WalkthroughViewController{
                window?.rootViewController = instantiateVC
            }
        }
